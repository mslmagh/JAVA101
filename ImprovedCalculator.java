...
public class ImprovedCalculator {
    ...
    static void mod() {
        ...
        if (Number2 <= 0) {
            System.out.println("Mod değeri pozitif olmalıdır.");
            System.out.println(-1);
            // Hata durumunu belirtmek için -1 döndürülebilir.
        }
    ...
    static void rectangle() {
        ...
        double shortSide = inp.nextDouble();
        System.out.print("Uzun kenarı giriniz: ");
        double longSide = inp.nextDouble();
